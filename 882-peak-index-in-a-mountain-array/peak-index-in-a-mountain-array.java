class Solution {
    ...
    // return start cuase the actaully required answer will be in the ascending order phase we after mutilple iteraitons and calculations of the mid in the arr so we finally in the else becomes true wheer the mid value is lesss than the netx vlaue of the next midd so thats the point we want to find so here start acts as index value so finally the asnwer is here bleow
}